...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Vincent Wen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '连接那些看似不相关的点', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://vincent-wen.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Vincent Wen, 博客', // 网站关键词 英文逗号隔开
